...
The goal of regexcitepfazlali is to make regular expressions more
...
You can install the development version of regexcitepfazlali from
[GitHub](https://github.com/) with:

``` r
# install.packages("devtools")
devtools::install_github("paradise1260/regexcitepfazlali")
```
...
That’s exactly what `regexcitepfazlali::str_split_one()` does.
